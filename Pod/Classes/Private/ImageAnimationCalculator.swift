...
class ImageAnimationCalculator: ImageAnimationCalculatorProtocol {
    ...
    fileprivate let randomGenerator: RandomGeneratorProtocol
    fileprivate let animationDependencies: ImageAnimationDependencies
    ...
    fileprivate func imageScaleForAspectFill(imageSize: CGSize, viewPortSize: CGSize) -> CGFloat {
